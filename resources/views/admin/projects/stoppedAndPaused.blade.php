...
@section('pagecomment')
<ol class="breadcrumb">
    <li class="breadcrumb-item active">Paused Projects</li>
</ol>
@stop
    ...
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">View Paused Projects</h4>
            
             <div class="alert alert-info alert-dismissible fade show" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
                <strong>View Projects!</strong> Here you can view all Paused Projects
             </div>
